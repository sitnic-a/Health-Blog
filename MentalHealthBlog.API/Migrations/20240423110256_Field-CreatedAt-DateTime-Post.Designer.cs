...
namespace MentalHealthBlogAPI.Migrations
{
    ...
    [Migration("20240423110256_Field-CreatedAt-DateTime-Post")]
    partial class FieldCreatedAtDateTimePost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MentalHealthBlogAPI.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "Content_T01",
                            CreatedAt = new DateTime(2024, 4, 23, 13, 2, 55, 936, DateTimeKind.Local).AddTicks(5212),
                            Title = "Title_01",
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Content = "Content_T02",
                            CreatedAt = new DateTime(2024, 4, 23, 13, 2, 55, 936, DateTimeKind.Local).AddTicks(5266),
                            Title = "Title_02",
                            UserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Content = "Content_T03",
                            CreatedAt = new DateTime(2024, 4, 23, 13, 2, 55, 936, DateTimeKind.Local).AddTicks(5271),
                            Title = "Title_03",
                            UserId = 2
                        },
                        new
                        {
                            Id = 4,
                            Content = "Content_T04",
                            CreatedAt = new DateTime(2024, 4, 23, 13, 2, 55, 936, DateTimeKind.Local).AddTicks(5275),
                            Title = "Title_04",
                            UserId = 2
                        },
                        new
                        {
                            Id = 5,
                            Content = "Content_T05",
                            CreatedAt = new DateTime(2024, 4, 23, 13, 2, 55, 936, DateTimeKind.Local).AddTicks(5279),
                            Title = "Title_05",
                            UserId = 1
                        });
                });
