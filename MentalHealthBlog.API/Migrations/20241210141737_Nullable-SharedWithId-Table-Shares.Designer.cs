...
namespace MentalHealthBlogAPI.Migrations
{
    ...
    [Migration("20241210141737_Nullable-SharedWithId-Table-Shares")]
    partial class NullableSharedWithIdTableShares
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MentalHealthBlogAPI.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "Content_T01",
                            CreatedAt = new DateTime(2024, 12, 10, 15, 17, 37, 387, DateTimeKind.Local).AddTicks(5006),
                            Title = "Title_01",
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Content = "Content_T02",
                            CreatedAt = new DateTime(2024, 12, 10, 15, 17, 37, 387, DateTimeKind.Local).AddTicks(5055),
                            Title = "Title_02",
                            UserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Content = "Content_T03",
                            CreatedAt = new DateTime(2024, 12, 10, 15, 17, 37, 387, DateTimeKind.Local).AddTicks(5056),
                            Title = "Title_03",
                            UserId = 2
                        },
                        new
                        {
                            Id = 4,
                            Content = "Content_T04",
                            CreatedAt = new DateTime(2024, 12, 10, 15, 17, 37, 387, DateTimeKind.Local).AddTicks(5058),
                            Title = "Title_04",
                            UserId = 2
                        },
                        new
                        {
                            Id = 5,
                            Content = "Content_T05",
                            CreatedAt = new DateTime(2024, 12, 10, 15, 17, 37, 387, DateTimeKind.Local).AddTicks(5059),
                            Title = "Title_05",
                            UserId = 1
                        });
                });
